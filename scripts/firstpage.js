...
var companyName = ("Krafty Kidwai Design");
...
var introDate = ("<h3>Today is " + currentTime + " on " + months[todayDate.getMonth()] + " " + todayDate.getDate() + " " + todayDate.getFullYear() + "<br>");
var introWelcome = (companyName + " Weclome's You, " + userName + "! <br> We are glad you are doing " + userFeeling + "!");
